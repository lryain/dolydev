...
int main() {
	...
	// (The library currently does not export a setter for iris position)
	// Example previously used EyeControl::setIrisPosition but the shared
	// library built for this workspace lacks that symbol.  Skip or implement
	// the movement in a future SDK update.
	// EyeControl::setIrisPosition(EyeSide::BOTH, 120, 120, 1.2, 1.2, 0, 180);
