...
def test_drive_commands():
    ...
    tests = [
        ...
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_forward", "speed": 0.25, "duration": 1.0}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_turn_left", "speed": 0.25, "duration": 1.0}),
        # ("电机右转1s", "io.pca9535.control", {"action": "motor_backward", "speed": 0.25, "duration": 1.0}),
        # ("电机停止", "io.pca9535.control", {"action": "motor_stop"}),
        # ("电机右转1s", "io.pca9535.control", {"action": "motor_backward", "speed": 0.25, "duration": 1.0}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_forward", "speed": 0.25, "duration": 1.0}),
        # ("电机停止", "io.pca9535.control", {"action": "motor_stop"}),
        # ("电机停止", "io.pca9535.control", {"action": "motor_stop"}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_turn_right", "speed": 0.25, "duration": 1.0}),
        # ("电机停止", "io.pca9535.control", {"action": "motor_stop"}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_turn_left", "speed": 0.25, "duration": 1.0}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_turn_right", "speed": 0.25, "duration": 1.0}),
        # ("电机左转1s", "io.pca9535.control", {"action": "motor_turn_left", "speed": 0.25, "duration": 1.0}),
