...
paths = [
    ...
    {"alias": "music_nature_60s", "priority": 10},
    # 压制并抢占
    # {"alias": "animal_wolf", "ducking": True, "preempt": True, "priority": 2},
    # 新闻播报 压制但不抢占
    # {"uri": "/home/pi/dolydev/libs/audio_player/testing/beaking-news.wav", "ducking": True, "priority": 10},

    # {"alias": "animal_duck", "ducking": True, "priority": 2},
